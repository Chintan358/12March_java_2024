...
<body>
		...
		<div class="row">
			...
			<div class="col-md-5 card p-5 shadow-lg m-auto">
				<h1 align="center" class="text-success">Update form</h1>
				...
				<form action="update" method="post">
					...
					<div class="form-group">
						<label for="uname">Username</label> <input type="text" id="uname"
							name="uname" class="form-control" onkeyup="validation()" value="<%=map.get("uname")%>">
						<span id="unameErr" class="text-danger"></span>
					</div>

					<div class="form-group">
						<label for="email">Email</label> <input type="text" id="email"
							name="email" class="form-control" onkeyup="validation()"  value="<%=map.get("email")%>">
					...
					<div class="form-group">
						<label for="pass">Password</label> <input type="password"
							id="pass" name="pass" class="form-control" onkeyup="validation()"  value="<%=map.get("pass")%>">
					...
					<input type="submit" class="btn btn-success" id="smbtn" value="Update"> 
