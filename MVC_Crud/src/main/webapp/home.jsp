				...
				<form action="reg" method="post">
					...
					<div class="form-group">
						<label for="uname">Username</label> <input type="text" id="uname"
							name="uname" class="form-control" onkeyup="validation()" value="${udata.getUname()}">
						<span id="unameErr" class="text-danger"></span>
					</div>

					<div class="form-group">
						<label for="email">Email</label> <input type="text" id="email"
							name="email" class="form-control" onkeyup="validation()" value="${udata.getEmail()}">
					...
					<div class="form-group">
						<label for="pass">Password</label> <input type="password"
							id="pass" name="pass" class="form-control" onkeyup="validation()" value="${udata.getPass()}">
